...
import { Building2, Users, Settings2, Activity } from 'lucide-react';
        ...
        <Card x-chunk="dashboard-01-chunk-5">
          ...
          <CardContent className="grid gap-4">
            <div className="flex items-center space-x-4 rounded-md border p-4">
              ...
              <div className="flex-1 space-y-1">
                <p className="text-sm font-medium leading-none">事業所を追加</p>
            ...
            <div className="flex items-center space-x-4 rounded-md border p-4">
              ...
              <div className="flex-1 space-y-1">
                <p className="text-sm font-medium leading-none">ケアマネージャーを追加</p>
                <p className="text-sm text-muted-foreground">新しいケアマネージャーを登録</p>
              </div>
            </div>
          </CardContent>
        </Card>
