      ...
      <div className="mx-auto w-full max-w-4xl space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button asChild className="w-full" size="lg">
                <Link href="/facility/login">施設管理者としてログイン</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button asChild className="w-full" size="lg">
                <Link href="/operation/login">運営者としてログイン</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button asChild className="w-full" size="lg">
                <Link href="/care-manager/login">ケアマネージャーとしてログイン</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>© 2024 CareBase. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
