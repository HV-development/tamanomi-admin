...
- 画面名: `施設管理者パスワード再設定`
- パス: `/facility/password-reset/confirm`
- URL: https://carebase-admin.vercel.app/facility/password-reset/confirm?token={reset_token}
...
| ------------------------ | --------------- | ---- | -------- | -------- | ------------ | ------------------------------------ | ---------------------------------------------------------- |
| ページタイトル           | CardTitle       | -    | -        | -        | -            | 施設管理者パスワード再設定           | カード内ヘッダー                                           |
...
| ログインページへ遷移     | パスワードリセット成功後の画面遷移 | -                                   | ログイン画面 (`/facility/login`) |
| 自動ログイン（将来実装） | リセット成功後の自動認証           | `/api/v1/auth/admin/login`          | 運営管理画面TOP (`/facility`)    |
...
```
https://carebase-admin.vercel.app/facility/password-reset/confirm?token={reset_token}
```
